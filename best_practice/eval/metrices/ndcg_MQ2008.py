...
def ndcg_at_k_measure(sess, model, query_pos_test, query_pos_train, query_url_features, k=5):
    ndcg = 0.0
    cnt = 0
...
def ndcg_at_k_user_measure(sess, model, query_pos_test, query_pos_train, query_url_features, k=5):
    ndcg_list = []
