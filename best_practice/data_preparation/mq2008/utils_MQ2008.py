    ...
    with open(file) as fin:
        for line in fin:
            ...
            if query in query_url_feature.keys():
                ...
                query_index_urls[query].append(url)
                query_urls[query][url] = len(query_index_urls[query]) - 1
            else:
                query_url_feature[query] = {url: feature}
                query_index_urls[query] = [url]
                query_urls[query] = {url: 0}
    return query_url_feature, query_urls, query_index_urls
