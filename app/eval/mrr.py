...
def mrr_measure(sess, model, query_pos_test, query_pos_train, query_url_features):
    rs = []
...
def mrr_user_measure(sess, model, query_pos_test, query_pos_train, query_url_features):
    rs = []
    ...
    return [__cal_mrr(r) for r in rs]
